...
namespace reexmonkey.xmisc.core.cryptography.extensions
{
    ...
    public static class GenericTypeCryptographicExtensions
    {
        ...
        /// The type of the serializer that serializes the instance of <typeparamref name="TValue"/>
        /// into bytes.
        /// </typeparam>
        /// <param name="value">The value whose hash code shall be computed.</param>
        /// <param name="serializer">
        /// The serializer that serializes the specified <paramref name="value"/> into bytes.
        /// </param>
        ...
        /// <param name="value">The value whose hash code shall be computed.</param>
        /// <param name="serializer">
        /// The serializer that serializes the specified <paramref name="value"/> into a string.
        /// </param>
        ...
        /// <summary>
        /// Computes the cryptographic salt and hash values of the instance of the specifed type
        /// <typeparamref name="TValue"/>. Returns the cryptographic salt value of the hash.
        /// </summary>
        /// <typeparam name="TValue">The type of instance, whose hashed value shall be salted.</typeparam>
        /// <typeparam name="TSerializer">
        /// The type of the serializer that serializes the instance of <typeparamref name="TValue"/>
        /// into an array of <see cref="byte"/> s.
        /// </typeparam>
        /// <param name="value">The value, whose salt and hash shall be computed.</param>
        /// <param name="serializer">
        /// The serializer that serializes the specified <paramref name="value"/> into an array of
        /// <see cref="byte"/> s.
        /// </param>
        /// <param name="cipher">
        /// The cryptographic hash algorithm used to compute the hash of the <paramref name="value"/>
        /// </param>
        /// <param name="sprinkler">
        /// The number generator that generates a strong random cryptographic salt value.
        /// </param>
