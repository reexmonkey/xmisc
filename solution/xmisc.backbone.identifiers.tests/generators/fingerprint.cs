...
namespace reexmonkey.xmisc.backbone.identifiers.tests.generators
{
    public class FingerprintTests
    {
        ...
        {
            //arrange
            var generator = new Md5FingerprintGenerator(Md5Guid.DnsNamespaceId, Fixture.Encoding, new MessagePackSerializer());
        ...
        {
            //arrange
            var generator = new Md5FingerprintGenerator(Md5Guid.DnsNamespaceId, Fixture.Encoding, new ProtoBufSerializer());
        ...
        {
            //arrange
            var generator = new Sha1FingerprintGenerator(Md5Guid.DnsNamespaceId, Fixture.Encoding, new BinaryFormatSerializer());
